    ...
    def __call__(self, results):
        ...
        for x_offset, y_offset in offsets:
            ...
            if os.path.exists('img' + str(i) + '.jpg'):
                ...
                cv2.imwrite('img' + str(i) + '.jpg', crop[0])
            i = i + 1
            cropped.extend(crop)
...
class DecordInit:
    ...
    def __call__(self, results):
        ...
        # results['mid_frame'] = container[len(container)// 2].asnumpy()
        return results
...
class FormatShape:
    ...
    def __call__(self, results):
        ...
        results['mid_frame'] = imgs[int(imgs.shape[0]/2),:,:,:]
        
        results['ori_imgs'] = imgs.copy()
