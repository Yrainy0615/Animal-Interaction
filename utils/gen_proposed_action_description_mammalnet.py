...
# --- 行動タイプ定義 ---
BEHAVIOR_TYPES = {
    # --- 'behavior_to_id.txt' に記載されているクラス名とタイプを記述 ---
    "drinks_water": "Solo",
    "sleeps": "Solo",
    "eats_food": "Solo",
    "mates_with_other_animals": "Interactive",
    "nurses_or_breastfeeds_its_baby": "Interactive",
    "pees": "Solo",
    "grooms/cleans_itself_or_other_animal": "Interactive",
    "poops": "Solo",
    "fights_against_other_animals": "Interactive",
    "hunts_other_animals": "Interactive",
    "vomits": "Solo",
    "gives_birth_to_a_baby": "Solo",
}
